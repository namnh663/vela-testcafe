...
(function () {
    ...
    ***************************************************************************** */
    ...
    var MoveAutomation = /** @class */ (function () {
        function MoveAutomation(el, offset, moveOptions, win, cursor, proxylessInput) {
            if (proxylessInput === void 0) { proxylessInput = null; }
        ...
        MoveAutomation.create = function (el, moveOptions, win, cursor, proxylessInput) {
            if (proxylessInput === void 0) { proxylessInput = null; }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, new MoveAutomation(element, offset, moveOptions, win, cursor, proxylessInput)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!this.proxylessInput) return [3 /*break*/, 4];
                            events_1 = [];
                            return [4 /*yield*/, mouseMoveStep(mouseMoveOptions, hammerhead.nativeMethods.dateNow, function (currPosition) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0: return [4 /*yield*/, ((_a = this.proxylessInput) === null || _a === void 0 ? void 0 : _a.createMouseMoveEvent(currPosition))];
                                            case 1:
                                                moveEvent = _b.sent();
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.proxylessInput.executeEventSequence(events_1)];
                        case 2:
                            _a.sent();
        ...
        MoveAutomation.prototype._moveToCurrentFrame = function (endPoint, proxylessMove) {
            var _this = this;
        ...
        MoveAutomation.prototype.run = function () {
            ...
            return this._scroll()
                ...
                if (!boundary.contains(endPoint))
                    return void 0;
                return _this._moveToCurrentFrame(endPoint, !!_this.proxylessInput)
    ...
    var CALCULATE_TOP_LEFT_POINT_REQUEST_CMD = 'proxyless|calculate-top-left-point|request';
    var CALCULATE_TOP_LEFT_POINT_RESPONSE_CMD = 'proxyless|calculate-top-left-point|response';
    ...
    var ProxylessInput = /** @class */ (function () {
        function ProxylessInput(dispatchEventFn) {
        ...
        ProxylessInput.prototype.createMouseMoveEvent = function (currPosition) {
            return __awaiter(this, void 0, void 0, function () {
                var options;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    var VisibleElementAutomation = /** @class */ (function (_super) {
        ...
        function VisibleElementAutomation(element, offsetOptions, win, cursor, dispatchProxylessEventFn) {
            ...
            _this.window = win;
            _this.cursor = cursor;
            _this.proxylessInput = dispatchProxylessEventFn ? new ProxylessInput(dispatchProxylessEventFn) : null;
            // NOTE: only for legacy API
            _this._ensureWindowAndCursorForLegacyTests(_this);
            _this.cursor.shouldRender = !_this.proxylessInput;
            return _this;
        }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, MoveAutomation.create(this.element, moveOptions, this.window, this.cursor, this.proxylessInput)];
                        case 1:
    ...
    var HoverAutomation = /** @class */ (function (_super) {
        ...
        function HoverAutomation(element, hoverOptions, dispatchProxylessEventFn) {
            return _super.call(this, element, hoverOptions, window, cursor, dispatchProxylessEventFn) || this;
        }
