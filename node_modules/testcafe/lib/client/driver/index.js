...
(function () {
    ...
    ***************************************************************************** */
    ...
    ActionExecutor.ACTIONS_HANDLERS[COMMAND_TYPE.hover] = {
        create: function (command, elements, dispatchProxylessEventFn) {
            return new testcafeAutomation.Hover(elements[0], command.options, dispatchProxylessEventFn);
        },
    };
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._runInActiveIframe = function (command) {
            ...
            runningChain
                ...
                return _this.activeChildIframeDriverLink.executeCommand(command, _this.speed, _this.options.proxyless);
            })
        ...
        Driver.prototype.createDispatchProxylessEventFunctions = function () {
