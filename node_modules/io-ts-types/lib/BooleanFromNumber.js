...
exports.BooleanFromNumber = void 0;
/**
 * @since 0.5.13
 */
 ...
 * @since 0.5.13
 */
exports.BooleanFromNumber = new t.Type('BooleanFromNumber', t.boolean.is, function (u, c) {
    return pipeable_1.pipe(t.number.validate(u, c), Either_1.map(function (n) { return n !== 0; }));
}, Number);
