...
class Proxy extends router_1.default {
    ...
    async _onServiceMessage(req, res, serverInfo) {
        ...
        if (msg && session) {
            try {
                ...
                (0, http_2.respondWithJSON)(res, result, false, this.isProxyless);
            }
            catch (err) {
    ...
    _onRequest(req, res, serverInfo) {
        ...
        if (!this._route(req, res, serverInfo))
            (0, request_pipeline_1.run)(req, res, serverInfo, this.openSessions, this.isProxyless);
    }
    ...
    openSession(url, session, externalProxySettings) {
        ...
        const { disableHttp2, disableCrossDomain, proxyless, } = this.proxyOptions;
        if (disableHttp2)
    ...
    switchToProxyless() {
        this.proxyOptions.proxyless = true;
    }
    get isProxyless() {
        return !!this.proxyOptions.proxyless;
    }
}
